...
//         { id: 'p2', name: 'p2', startDate: new Date(3), endDate: new Date(5), color: 'blue' },
//         { id: 'p2', name: 'S', startDate: new Date(5), endDate: new Date(6), color: 'red' },
//         { id: 'p1', name: 'p1', startDate: new Date(6), endDate: new Date(8), color: 'blue' },
//         { id: 'p3', name: 'p3', startDate: new Date(8), endDate: new Date(10), color: 'blue' },
//         { id: 'p4', name: 'p4', startDate: new Date(10), endDate: new Date(12), color: 'blue' },
//         { id: 'p4', name: 'S', startDate: new Date(12), endDate: new Date(13), color: 'red' },
...
//         { id: 'p4', name: 'p4', startDate: new Date(16), endDate: new Date(17), color: 'blue' },
//         { id: 'p2', name: 'p2', startDate: new Date(17), endDate: new Date(19), color: 'blue' },
//         { id: 'p2', name: 'S', startDate: new Date(19), endDate: new Date(20), color: 'red' },
//         { id: 'p2', name: 'p2', startDate: new Date(20), endDate: new Date(22), color: 'blue' },
//         { id: 'p2', name: 'S', startDate: new Date(22), endDate: new Date(23), color: 'red' },
//         { id: 'p2', name: 'p2', startDate: new Date(23), endDate: new Date(25), color: 'blue' },
//         { id: 'p2', name: 'S', startDate: new Date(25), endDate: new Date(26), color: 'red' },
//         { id: 'p2', name: 'p2', startDate: new Date(26), endDate: new Date(28), color: 'blue' },
//       ]
